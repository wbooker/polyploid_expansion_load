...
for(i in 1:5){
  dat <- read.csv(paste(c("/proj/dschridelab/wwbooker/polyploid_expansion_load/output/allo_K-25_m-0.05_r-0.693147_u-2.5e-11_rho-2.5e-11_bs-0.0_ds--0.005_g-999999999",i,"_fitnesses.csv"),sep="", collapse=""), row.names = 1)
  dat <- dat[1:60,1:850]
